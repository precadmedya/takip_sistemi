...
$keys = ['mail_logo','smtp_host','smtp_port','smtp_encryption','smtp_user','smtp_pass','smtp_from_name','smtp_from_email','smtp_timeout'];
$settings=[];
$errors=[];
$save_message='';
$test_message='';
...
if($_SERVER['REQUEST_METHOD']==='POST'){
    ...
    if(empty($errors)){
        foreach(['smtp_host','smtp_port','smtp_encryption','smtp_user','smtp_pass','smtp_from_name','smtp_from_email','smtp_timeout'] as $k){
            if(isset($_POST[$k])){
