...
İlk giriş için veritabanına iki örnek kullanıcı eklenmiştir:

- Yönetici: `info@precadmedya.com.tr` / `123456`
- Ajans Kullanıcısı: `ajans@example.com` / `ajans123`

Yönetici tüm verileri görüntüleyebilir ve yeni kullanıcı oluşturabilir. Ajans türündeki kullanıcı ise sadece kendi eklediği müşterileri, hizmetleri, ürünleri ve sağlayıcıları görür.
...
- `/products.php` – Ürün yönetimi (CSV dışa/içe aktarım destekler)
...
Müşteri tablosu varsayılan olarak şirket adına göre alfabetik sıralanır. Başlıklara tıklayarak bakiye veya diğer sütunlara göre artan ya da azalan şekilde sıralama yapılabilir.
