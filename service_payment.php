...
if($_SERVER['REQUEST_METHOD']==='POST'){
    ...
    $stmt->execute([$customer_id,$service['product_id'],$service['provider_id'],$service['site_name'],$service['service_type'],$start,$due,$duration,$service['price']*$years,$service['currency'],$service['vat_rate'],$price_try,$service['status'],$service['notes']]);
